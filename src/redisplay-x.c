...
#if 0 /* #### this is from xft reloaded #3 */
#ifdef USE_XFT
...
# ifdef THIS_NEEDS_TO_GO_AWAY
static XftColor x_xft_get_color (Display *dpy, Colormap cmap, Lisp_Object c);
# endif
#endif /* USE_XFT */
...
#ifdef THIS_NEEDS_TO_GO_AWAY
static XftColor
x_xft_get_color (Display *dpy, Colormap cmap, Lisp_Object c)
{
