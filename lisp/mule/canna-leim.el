...
;; use (locate-file "cannaapi" module-load-path module-extensions)
;; to locate the module without loading it.
;; then we could autoload canna-activate and dump and/or autoload:
;; (and (locate-file "cannaapi" module-load-path module-extensions)
...
(defun canna-activate (&optional name)
  ...
  (unless (require 'CANNA "cannaapi" 'no-error)
    (error 'file-error
